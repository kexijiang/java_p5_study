...
/**
 * @author kxjiang 时间: 2021/12/22 描述: Callable案例类
 */
...
public class CallableExample implements Callable<String> {
    ...
    public static void main(String[] args) throws Exception {
        ThreadFactory namedThreadFactory = new ThreadFactoryBuilder().setNameFormat("example-pool-%d").build();
        ExecutorService executor =
            new ThreadPoolExecutor(1, 1, 1000, TimeUnit.MINUTES, new ArrayBlockingQueue<>(5), namedThreadFactory);
