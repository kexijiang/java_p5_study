...
public class MMAPExample {
    public static void main(String[] args) throws IOException {
        ...
        FileChannel inChannel = FileChannel
            .open(Paths.get("G:\\chromeDownload\\devecostudio-windows-tool-3.0.0.601.zip"), StandardOpenOption.READ);
        FileChannel outChannel =
            FileChannel.open(Paths.get("G:\\chromeDownload\\devecostudio-windows-tool-3.0.0.601_cp.zip"),
